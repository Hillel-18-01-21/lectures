...
const poll = [
    ...
    {
        question: `Как можно реализовать "приватные" поля у классов/объектов?`,
        options: {
            0: 'ключевое слово private в классе',
            1: 'с помощью get/set',
            2: 'в классе добавить # перед приватными полями',
            3: 'через замыкания',
            4: 'в JS нет приватных полей у объектов',
            5: 'через дескриптор полей у объектов'
        }
    }
];